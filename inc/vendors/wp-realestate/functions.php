...
add_filter( 'wp-realestate-create-attachment-remove-image-sizes', 'homeo_property_create_attachment_remove_image_sizes', 100);
function homeo_property_create_attachment_remove_image_sizes($sizes) {
	$layout_type = homeo_get_config('property_layout_type', 'v1');
	switch ($layout_type) {
		case 'v1':
			$sizes[] = 'homeo-gallery-v2-large';
			$sizes[] = 'homeo-gallery-v2-small';
			$sizes[] = 'homeo-gallery-v3';
			$sizes[] = 'homeo-gallery-v4-large';
			$sizes[] = 'homeo-gallery-v4-small';
			$sizes[] = 'homeo-gallery-v5';
			break;
		case 'v2':
			$sizes[] = 'homeo-gallery-v1';
			$sizes[] = 'homeo-gallery-v3';
			$sizes[] = 'homeo-gallery-v4-large';
			$sizes[] = 'homeo-gallery-v4-small';
			$sizes[] = 'homeo-gallery-v5';
