	...
	if ( $types && ! is_wp_error( $types ) ) {
		...
		<div class="property-type">
			...
			<?php
				...
				$product_types = wp_get_object_terms( $post->ID,  'property_type' );
    	         echo'<div class="prop_type"><a href="'.get_term_link($product_types[0]->term_id,'property_type').'" class="prop-type-single">'.$product_types[0]->name.'</a></div>';
	    	?>
	    	</div>
	    </div>
    	<?php
...
// 	$price = $obj_property_meta->get_price_html();
	...
	if ( $price ) {
		if ( $display_type == 'icon' ) {
			...
			?>
			<div class="property-price"><?php echo 'USD '; echo trim($price); ?></div>
			<?php
		}
    }
    $output = ob_get_clean();
...
function homeo_property_print_btn($post, $show_title = false) {
	if ( homeo_get_config('property_enable_printer', true) ) {
        ?>
        <a href="javascript:void(0);" class="btn-print-property" data-property_id="<?php echo esc_attr($post->ID); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce( 'homeo-printer-property-nonce' )); ?>" data-toggle="tooltip" title="<?php esc_attr_e('Print', 'homeo'); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="17.5" viewBox="0 0 20 17.5"><path id="icon-printer" d="M29,27V21m0,6V21M10,27V21m20,6V21m-6.75,5.75h-6.5a.5.5,0,0,0,0,1h6.5a.5.5,0,0,0,0-1Zm0,2.5h-6.5a.5.5,0,0,0,0,1h6.5a.5.5,0,0,0,0-1Zm0-2.5h-6.5a.5.5,0,0,0,0,1h6.5a.5.5,0,0,0,0-1Zm0,2.5h-6.5a.5.5,0,0,0,0,1h6.5a.5.5,0,0,0,0-1Zm0,0h-6.5a.5.5,0,0,0,0,1h6.5a.5.5,0,0,0,0-1Zm0-2.5h-6.5a.5.5,0,0,0,0,1h6.5a.5.5,0,0,0,0-1Zm-6.5,1h6.5a.5.5,0,0,0,0-1h-6.5a.5.5,0,0,0,0,1Zm6.5,1.5h-6.5a.5.5,0,0,0,0,1h6.5a.5.5,0,0,0,0-1ZM28,19H26.25V15.5a.5.5,0,0,0-.5-.5H14.25a.5.5,0,0,0-.5.5V19H12a2.006,2.006,0,0,0-2,2v6a2.006,2.006,0,0,0,2,2h1.75v3a.5.5,0,0,0,.5.5h11.5a.5.5,0,0,0,.5-.5V29H28a2.006,2.006,0,0,0,2-2V21A2.006,2.006,0,0,0,28,19ZM14.75,16h10.5v3H14.75Zm10.5,15.5H14.75v-6h10.5ZM29,27a1,1,0,0,1-1,1H26.25V25a.5.5,0,0,0-.5-.5H14.25a.5.5,0,0,0-.5.5v3H12a1,1,0,0,1-1-1V21a1,1,0,0,1,1-1H28a1,1,0,0,1,1,1Zm-12.25.75h6.5a.5.5,0,0,0,0-1h-6.5a.5.5,0,0,0,0,1Zm0,2.5h6.5a.5.5,0,0,0,0-1h-6.5a.5.5,0,0,0,0,1Zm6.5-1h-6.5a.5.5,0,0,0,0,1h6.5a.5.5,0,0,0,0-1Zm0-2.5h-6.5a.5.5,0,0,0,0,1h6.5a.5.5,0,0,0,0-1Zm0,0h-6.5a.5.5,0,0,0,0,1h6.5a.5.5,0,0,0,0-1Zm0,2.5h-6.5a.5.5,0,0,0,0,1h6.5a.5.5,0,0,0,0-1Z" transform="translate(-10 -15)" fill="#484848"/></svg>
        	<?php if ( $show_title ) { ?>
