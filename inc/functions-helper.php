...
function homeo_display_header_builder($header_slug) {
	...
	foreach ( $post_ids as $post_id ) {
		$post_id = homeo_get_lang_post_id($post_id, 'apus_header');
...
function homeo_display_footer_builder($footer_slug) {
	...
	$post_ids = get_posts($args);
	foreach ( $post_ids as $post_id ) {
		$post_id = homeo_get_lang_post_id($post_id, 'apus_footer');
		$post = get_post($post_id);
...
function homeo_get_lang_post_id($post_id, $post_type = 'page') {
